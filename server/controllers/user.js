...
exports.register = async (req, res) => {
    ...
    transporter.sendMail({
        to: user.email,
        from: "couriermanagementsystem58@gmail.com",
        subject: "signup successful",
        html:"<h1>welcome to CMS</h1>"
    });
    res.status(201).json({
            ...
            .then(user=>{
                ...
                user.save().then((result)=>{
                    transporter.sendMail({
                        to: user.email,
                        from: "couriermanagementsystem58@gmail.com",
                        subject: "OTP to log into CMS",
                        html:
                        `<h4> Your OTP for logging into CMS is : ${enroute_otp}, <p>use this OTP to complete the verification process.</p> </h4>`
                    })
